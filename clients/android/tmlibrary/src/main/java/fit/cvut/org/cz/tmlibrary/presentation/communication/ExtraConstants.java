...
public class ExtraConstants {
    ...
    public static final String EXTRA_TOURNAMENTS_COUNT = "extra_tournaments_count";
    public static final String EXTRA_MATCHES_COUNT = "extra_matches_count";
    public static final String EXTRA_TEAMS_COUNT = "extra_teams_count";

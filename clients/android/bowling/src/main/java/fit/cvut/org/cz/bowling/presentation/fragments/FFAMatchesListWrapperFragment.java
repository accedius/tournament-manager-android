 ...
 */
public abstract class FFAMatchesListWrapperFragment extends Fragment {
    public static FFAMatchesListWrapperFragment newInstance(long id, Class<? extends FFAMatchesListWrapperFragment> clazz){
        FFAMatchesListWrapperFragment fragment = null;
        try {
            Constructor<? extends FFAMatchesListWrapperFragment> c = clazz.getConstructor();
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        return inflater.inflate(R.layout.fragment_ffa_matches_list, container, false);
    }

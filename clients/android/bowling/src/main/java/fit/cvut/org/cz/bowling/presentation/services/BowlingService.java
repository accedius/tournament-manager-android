    ...
    protected void doWork(Intent intent) throws SQLException {
        ...
        switch (action) {
            case CrossPackageConstants.ACTION_GET_STATS: {
                ...
                as.addRecord(new PlayerAggregatedStatsRecord(getString(R.string.mp), Long.toString(ags.getMatchPoints()), false));
                ...
                as.addRecord(new PlayerAggregatedStatsRecord(getString(R.string.amp), String.format("%.2f", ags.getAvgMatchPoints()), false));
                statsToSend.add(as);

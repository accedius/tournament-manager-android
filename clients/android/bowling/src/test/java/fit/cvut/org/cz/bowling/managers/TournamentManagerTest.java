package fit.cvut.org.cz.bowling.managers;
...
public class TournamentManagerTest {
    ...
    public void insert() {
        ...
        assertEquals(pointConfiguration.id, PointConfiguration.defaultConfig().id);
        assertEquals(pointConfiguration.placePoints, PointConfiguration.defaultConfig().placePoints);
        assertEquals(pointConfiguration.sidesNumber, PointConfiguration.defaultConfig().sidesNumber);
        assertEquals(pointConfiguration.tournamentId, PointConfiguration.defaultConfig().tournamentId);
        assertEquals(pointConfiguration.configurationPlacePoints, PointConfiguration.defaultConfig().configurationPlacePoints);
    }

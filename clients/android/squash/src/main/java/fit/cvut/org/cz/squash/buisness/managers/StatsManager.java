...
public class StatsManager implements IStatsManager {
    ...
    public ArrayList<AgregatedStats> getAgregatedStatsByCompetitionId(long competitionId) {
        ...
        stats.add(new AgregatedStats(0, "Pete", 63, 42, 1, 150, 90, 999999, 9999999, 2.1d, 1.3d, 54.3f, 33.12d, 61.23f, 72.5d));
        stats.add(new AgregatedStats(0, "Kate", 1000000000, 42, 1, 150, 90, 999999, 9999999, 2.1d, 1.3d, 54.3f, 33.12d, 61.23f, 72.5d));
        stats.add(new AgregatedStats(0, "Rocky", 12, 3, 2, 36, 23, 999999, 9999999, 2.1d, 1.3d, 54.3f, 33.12d, 61.23f, 72.5d));

    ...
    protected void doWork(Intent intent) {
        ...
        switch (action)
        {
            case CrossPackageComunicationConstants.ACTION_GET_STATS:
            {
                ...
                ArrayList<AggregatedStatistics> stats = ManagerFactory.getInstance().statisticsManager.getByPlayerID(this, id);
                ...
                for( AggregatedStatistics ags : stats ){
                    ...
                    as.addRecord(new PlayerAggregatedStatsRecord(getString(R.string.name), ags.getPlayerName(), true));
